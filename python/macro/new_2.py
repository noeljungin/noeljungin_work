...
# # 경고창을 띄우는 함수
def msg(str):
    QMessageBox.information( "error!", str)
#
# main
...
#     userDate = userDate + QDate[QDate.index("월") + 2:QDate.index("일")].rjust(2, '0')
    ...
    userPW = 'sanzo103'
    userNum = '851003'
    userSearch = 'http://ticket.interpark.com/Ticket/Goods/GoodsInfo.asp?GoodsCode=19007538'
    QDate = "<span style='color:#A90000'>선택된 날짜 : 2019년 t월 Aug 3일</span>"
    userTime = '1회차'
    userTicket = '일반'
    userBank = '농협'
    userDate = '20190tAug 3'
